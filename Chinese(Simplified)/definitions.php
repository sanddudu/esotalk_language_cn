...
$definitions["Change avatar"] = "修改头像";
...
$definitions["Make member and online list visible to:"] = "使成员和在线成员列表对该人可见:";
...
$definitions["New Conversation"] = "新的讨论";
...
$definitions["New posts in the past week"] = "过去一周的新回复";
$definitions["New username"] = "新用户名";
$definitions["Next Step"] = "下一步";
$definitions["Next"] = "下一个";
...
$definitions["Original Post"] = "原始文章";
...
$definitions["Post count"] = "回复统计";
$definitions["Posts"] = "Posts";
$definitions["Preview"] = "预览";
$definitions["Previous"] = "以前的";

$definitions["quote"] = "引用";

$definitions["Read more"] = "阅读更多";
$definitions["Recent posts"] = "最近回复";
